...
public class Entrypoint implements HttpFunction {
    ...
    public void service(HttpRequest request, HttpResponse response) throws Exception {
        ...
        String project_id = request.getFirstQueryParameter("projectid").orElse("cn2223-t1-g14");
        String grpName = request.getFirstQueryParameter("instance-group").orElse("instance-group-grpc");
        String zone = request.getFirstQueryParameter("zone").orElse("europe-west8-a");
